...
**R**, designed to evaluate and construct equity portfolios using modern
financial metrics. The analysis compares multiple portfolio
...
**Assets analyzed:** - Apple (AAPL)  - Microsoft (MSFT)  - Amazon
(AMZN)  - NVIDIA (NVDA)  - Alphabet (GOOGL) 
...
*Growth of \$1 invested across the optimized, constrained, equal-weight,
and SPY portfolios.*
...
•Higher-performing portfolios exhibit higher volatility, larger
drawdowns, and higher beta (greater market exposure).
